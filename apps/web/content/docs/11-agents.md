...
- **Do NOT** vary contract addresses by network. PromusAgentNFT, PromusSubnameRegistrar, PromusInbox, PromusMarket are CREATE2-deployed so mainnet (chainId 16661) and Galileo testnet (chainId 16602) share the same addresses. Only PromusSubnameRegistrar is mainnet-only by design.
