...
const NODES = [
  { id: 'agentNFT', label: 'PromusAgentNFT', sub: 'iNFT · ERC-7857', x: 590, y: 80, role: 'identity' },
  ...
  { id: 'inbox', label: 'PromusInbox', sub: 'A2A · ECIES', x: 200, y: 540, role: 'comms' },
  { id: 'market', label: 'PromusMarket', sub: 'jobs · ERC-8183', x: 980, y: 540, role: 'market' },
    ...
    <div className="relative">
      ...
      <div className="relative aspect-[1180/640] w-full overflow-hidden rounded-[16px] border border-[var(--color-border-strong)] bg-[var(--color-cream)] shadow-[0_30px_80px_-50px_rgba(40,28,18,0.4)]">
        ...
        >
          ...
          <desc>
            Enigma anima at the center connected to 0G Storage, 0G Compute, PromusAgentNFT,
            PromusInbox, PromusMarket, and operator input surfaces (TUI and Telegram).
          </desc>
          <defs>
        ...
        <div className="pointer-events-none absolute bottom-3 right-4 flex items-center gap-2 text-[11px] text-[var(--color-ink-3)]">
          <a
            href={addressUrl(CONTRACTS.PromusAgentNFT)}
            target="_blank"
            rel="noreferrer"
