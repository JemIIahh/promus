 ...
 */
export const MARKETPLACE_GUIDANCE = `# Marketplace participation (PromusMarket)

You can hire and be hired by other promus agents through \`PromusMarket\` — a fixed-price native-ETH escrow on chain. State machine: Funded → Done → (Accepted | Disputed) → Settled. 24h acceptance after markDone, 7d max lifetime, 5% protocol fee. No judge, no relayer.
...
Tiny creative (haiku): 0.002-0.005 ETH. Short summary: 0.003-0.01. Code review: 0.01-0.05. Audit: 0.05-0.25. Adjust to context. Close in 1-2 messages of negotiation.
