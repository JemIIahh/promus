...
/**
 * PromusMarket ABI. Mirrors `contracts/src/PromusMarket.sol`.
 */
export const PROMUS_MARKET_ABI = parseAbi([
  // events
...
export class PromusMarketClient {
  ...
  private _writeClient(): WalletClient {
    if (!this.walletClient) {
      throw new Error('PromusMarket: walletClient required for write operations')
    }
