...
//
// We don't spin a real chain — these tests stub the PromusInboxClient with a
...
import { derivePubkeyHex } from '@s0nderlabs/promus-core'
...
function stubInbox(script: StubScript): PromusInboxClient {
  return {
  ...
  } as unknown as PromusInboxClient
}
