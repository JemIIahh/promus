...
export const JAINE_BY_NETWORK: Record<PromusNetwork, JaineAddresses | null> = {
  '0g-mainnet': {
...
export const GIMO_BY_NETWORK: Record<PromusNetwork, GimoAddresses | null> = {
  '0g-mainnet': {
...
export function requireMainnet(network: PromusNetwork): asserts network is '0g-mainnet' {
