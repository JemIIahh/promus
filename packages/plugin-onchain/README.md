...
Auto-installed when you `bun add -g promus`. Or directly: `bun add promus-plugin-onchain`.

Requires [bun](https://bun.sh) ≥ 1.1.

See the [root README](https://github.com/JemIIahh/promus#readme) for the full tool reference.
