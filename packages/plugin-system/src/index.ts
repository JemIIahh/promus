/**
 * @s0nderlabs/promus-plugin-system: battery-included filesystem + shell + skills tools.
 *
...
import { LocalBackend, type NativePlugin, type ToolDef } from '@s0nderlabs/promus-core'
import {
