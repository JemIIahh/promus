/**
 * `<label>.promus.0g` subname validation.
 *
 * Rules locked Apr 23 2026 (project-promus.md section 33 + matches the
 * PromusSubnameRegistrar contract's on-chain check):
 *   - 3-32 characters total
 *   - lowercase a-z, 0-9, hyphens
 *   - no leading or trailing hyphen
 *
 * Used by:
 *   - `promus init` wizard's subname prompt (cli/commands/init.ts)
