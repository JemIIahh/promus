...
export class LedgerInsufficientError extends Error {
  ...
  constructor(opts: {
    ...
    super(
      `Compute ledger sub-account short by ${opts.shortfallOg} 0G (provider ${opts.providerAddress.slice(0, 10)}…, locked ${opts.availableOg} of ${opts.requiredOg} required). Topup with: promus topup --compute 2`,
    )
