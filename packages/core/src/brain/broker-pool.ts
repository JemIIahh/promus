 ...
 */
export const VISION_PROVIDER_DEFAULTS: Record<PromusNetwork, string | null> = {
  '0g-mainnet': '0x4415ef5CBb415347bb18493af7cE01f225Fc0868',
  '0g-testnet': null,
  // 0G-Compute vision provider; no equivalent on Arbitrum (vision routes through
  // the Anthropic-backed brain instead). Removed with the 0G brain.
