...
import { PromusAgentNFTReader, type IntelligentDataEntry, bootstrapHashFor } from '../identity'
...
export interface MakeMemoryListToolArgs {
  ...
  tokenId: bigint
  /** Test-injection point. Production passes a real `PromusAgentNFTReader.getIntelligentData` binding. */
