...
/**
 * The operator is the human (or organization) behind an promus agent. Per
 * project-promus.md section 22.1, the operator's wallet is what OWNS the
 * ERC-7857 iNFT. A separate agent EOA (generated by `promus init`) is a
...
export interface OperatorSigner {
  ...
  walletClient(network: PromusNetwork): Promise<WalletClient>
  /** A public client for the same network (reads only). */
  publicClient(network: PromusNetwork): Promise<PublicClient>
