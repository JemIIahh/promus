...
/// @notice Deploy PromusMarket via CREATE2. Same address on testnet + mainnet
...
contract DeployMarket is Script {
    ...
    function run() external returns (PromusMarket market) {
        ...
        market = new PromusMarket{salt: SALT}(feeRecipient);
        vm.stopBroadcast();
        console2.log("PromusMarket deployed at:", address(market));
