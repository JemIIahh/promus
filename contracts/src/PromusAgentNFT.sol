...
/// @notice Minimal ERC-7857 iNFT for Promus (first on-chain sovereign agent runtime on 0G).
...
/// - global TEE oracle (software-signed for MVP per project-promus.md section 30.6)
/// Per-token oracle rotation + authorizeUsage + iClone are deferred to Phase 11.
contract PromusAgentNFT is ERC721, Ownable {
    ...
    /// operator's wallet that owns the iNFT per project-promus.md section 22.1)
