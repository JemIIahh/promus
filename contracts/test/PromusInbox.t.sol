...
import {PromusInbox} from "../src/PromusInbox.sol";

/// @dev Used by `test_SendMessage_From_Contract_Caller_PreservesAddress`.
contract MockSender {
    PromusInbox internal immutable inbox;
    constructor(address inbox_) {
        inbox = PromusInbox(inbox_);
    }
...
contract PromusInboxTest is Test {
    PromusInbox internal inbox;
    ...
    function test_RevertWhen_PayloadOversize() public {
        ...
        vm.prank(alice);
        vm.expectRevert(PromusInbox.PayloadTooLarge.selector);
