...
import {PromusAgentNFT} from "../src/PromusAgentNFT.sol";

contract PromusAgentNFTTest is Test {
    PromusAgentNFT nft;
    address owner;
    uint256 oraclePk;
    address oracle;
    ...
    function _canonicalDatas() internal pure returns (PromusAgentNFT.IntelligentData[] memory) {
        ...
        PromusAgentNFT.IntelligentData[] memory ds = new PromusAgentNFT.IntelligentData[](6);
        for (uint256 i = 0; i < 6; i++) {
            ds[i] = PromusAgentNFT.IntelligentData({
    ...
    function test_MintSucceedsWithSixCanonicalSlots() public {
        ...
        PromusAgentNFT.IntelligentData[] memory got = nft.getIntelligentData(tokenId);
    ...
    function test_MintEmptyReverts() public {
        PromusAgentNFT.IntelligentData[] memory empty = new PromusAgentNFT.IntelligentData[](0);
        vm.expectRevert(PromusAgentNFT.EmptyIntelligentData.selector);
    ...
    function test_UpdateNonOwnerReverts() public {
        ...
        vm.prank(bob);
        vm.expectRevert(PromusAgentNFT.NotTokenOwner.selector);
        nft.update(tokenId, slots, hashes);
    }
    ...
    function test_UpdateInvalidSlotReverts() public {
        ...
        vm.prank(alice);
        vm.expectRevert(abi.encodeWithSelector(PromusAgentNFT.InvalidSlotIndex.selector, 99));
        nft.update(tokenId, slots, hashes);
    }
    ...
    function test_ITransferFromReplayReverts() public {
        ...
        vm.prank(alice);
        vm.expectRevert(PromusAgentNFT.ProofAlreadyConsumed.selector);
        nft.iTransferFrom(alice, bob, tokenId, newHashes, nonce, sig);
    }
    ...
    function test_ITransferFromWithBadOracleSigReverts() public {
        ...
        vm.prank(alice);
        vm.expectRevert(PromusAgentNFT.InvalidTransferProof.selector);
        nft.iTransferFrom(alice, bob, tokenId, newHashes, nonce, sig);
    }
    ...
    function test_UpdateLengthMismatchReverts() public {
        ...
        vm.prank(alice);
        vm.expectRevert(PromusAgentNFT.LengthMismatch.selector);
        nft.update(tokenId, slots, hashes);
    }
    ...
    function test_MintEmitsEvent() public {
        PromusAgentNFT.IntelligentData[] memory datas = _canonicalDatas();
        vm.expectEmit(true, true, false, true, address(nft));
        emit PromusAgentNFT.Minted(1, alice, datas);
    ...
    function test_UpdateEmitsEvent() public {
        ...
        emit PromusAgentNFT.Updated(tokenId, slots, hashes);
        nft.update(tokenId, slots, hashes);
    }
    ...
    function test_ITransferFromEmitsTransferredEvent() public {
        ...
        emit PromusAgentNFT.Transferred(tokenId, alice, bob);
        nft.iTransferFrom(alice, bob, tokenId, newHashes, nonce, sig);
    }
    ...
    function test_SetOracleEmitsOracleRotated() public {
        ...
        emit PromusAgentNFT.OracleRotated(oracle, newOracle);
        nft.setOracle(newOracle);
    }

    function test_GetSlotHashMatchesIntelligentData() public {
        uint256 tokenId = nft.mint(alice, _canonicalDatas());
        PromusAgentNFT.IntelligentData[] memory full = nft.getIntelligentData(tokenId);
    ...
    function test_ITransferFromWithCrossContractReplayReverts() public {
        ...
        PromusAgentNFT other = new PromusAgentNFT("Other", "OTH", oracle);
        uint256 tokenId = nft.mint(alice, _canonicalDatas());
