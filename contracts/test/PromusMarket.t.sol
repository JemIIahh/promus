...
import {PromusMarket} from "../src/PromusMarket.sol";
...
contract ReentrantBuyer {
    PromusMarket public market;
    uint256 public jobId;
    bool public reenter;

    function setMarket(address market_) external {
        market = PromusMarket(market_);
    }
...
contract PromusMarketTest is Test {
    PromusMarket internal market;
    ...
    function setUp() public {
        ...
        market = new PromusMarket(feeRecipient);
    ...
    function test_Constructor_RevertsOnZeroFeeRecipient() public {
        vm.expectRevert(PromusMarket.ZeroAddress.selector);
        new PromusMarket(address(0));
    }
    ...
    function test_RevertWhen_CreateJob_SelfTrade() public {
        vm.prank(buyer);
        vm.expectRevert(PromusMarket.SelfTrade.selector);
    ...
    function test_RevertWhen_CreateJob_BelowMinimum() public {
        ...
        vm.prank(buyer);
        vm.expectRevert(PromusMarket.AmountBelowMinimum.selector);
    ...
    function test_MarkDone_Happy() public {
        ...
        PromusMarket.Job memory j = market.getJob(jobId);
        assertEq(uint8(j.status), uint8(PromusMarket.JobStatus.Done));
    ...
    function test_RevertWhen_MarkDone_NotProvider() public {
        uint256 jobId = _createFundedJob();
        vm.prank(buyer);
        vm.expectRevert(PromusMarket.NotProvider.selector);
        market.markDone(jobId);
    }
    ...
    function test_RevertWhen_MarkDone_AlreadyDone() public {
        ...
        vm.expectRevert(
            abi.encodeWithSelector(
                PromusMarket.InvalidStatus.selector,
                jobId,
                PromusMarket.JobStatus.Funded,
                PromusMarket.JobStatus.Done
            )
        );
        market.markDone(jobId);
    }
    ...
    function test_RevertWhen_MarkDone_AfterAccept() public {
        ...
        vm.expectRevert(
            abi.encodeWithSelector(
                ...
                jobId,
                PromusMarket.JobStatus.Funded,
                PromusMarket.JobStatus.Settled
            )
        );
        market.markDone(jobId);
    }
    ...
    function test_RevertWhen_MarkDone_InvalidJobId() public {
        vm.prank(provider);
        vm.expectRevert(abi.encodeWithSelector(PromusMarket.JobNotFound.selector, uint256(99)));
        market.markDone(99);
    }
    ...
    function test_AcceptResult_Happy_PaysFeeAndProvider() public {
        ...
        assertEq(uint8(market.getJob(jobId).status), uint8(PromusMarket.JobStatus.Settled));
    ...
    function test_RevertWhen_AcceptResult_NotBuyer() public {
        ...
        _markDone(jobId);
        vm.prank(provider);
        vm.expectRevert(PromusMarket.NotBuyer.selector);
        market.acceptResult(jobId);
    }
    ...
    function test_Dispute_Happy() public {
        ...
        assertEq(uint8(market.getJob(jobId).status), uint8(PromusMarket.JobStatus.Disputed));
    }
    ...
    function test_RevertWhen_Dispute_AfterAcceptanceWindow() public {
        ...
        vm.prank(buyer);
        vm.expectRevert(
            abi.encodeWithSelector(PromusMarket.AcceptancePeriodExpired.selector, jobId)
        );
        market.dispute(jobId);
    }
    ...
    function test_RevertWhen_ClaimTimeout_BeforeWindow() public {
        ...
        _markDone(jobId);
        vm.expectRevert(
            abi.encodeWithSelector(PromusMarket.AcceptancePeriodNotExpired.selector, jobId)
        );
        market.claimTimeout(jobId);
    }
    ...
    function test_RevertWhen_ProposeSplit_NotInDispute() public {
        ...
        vm.expectRevert(
            abi.encodeWithSelector(
                PromusMarket.InvalidStatus.selector,
                jobId,
                PromusMarket.JobStatus.Disputed,
                PromusMarket.JobStatus.Funded
            )
        );
        market.proposeSplit(jobId, JOB_AMOUNT / 2, JOB_AMOUNT / 2);
    ...
    function test_RevertWhen_ProposeSplit_NotParty() public {
        ...
        vm.prank(stranger);
        vm.expectRevert(PromusMarket.NotParty.selector);
        market.proposeSplit(jobId, JOB_AMOUNT / 2, JOB_AMOUNT / 2);
    }
    ...
    function test_RevertWhen_ProposeSplit_AmountsDontSum() public {
        ...
        vm.prank(buyer);
        vm.expectRevert(
            abi.encodeWithSelector(PromusMarket.InvalidSplitAmounts.selector, JOB_AMOUNT - 1, JOB_AMOUNT)
        );
    ...
    function test_RevertWhen_ForceClose_BeforeMaxLifetime() public {
        uint256 jobId = _createFundedJob();
        vm.expectRevert(
            abi.encodeWithSelector(PromusMarket.MaxLifetimeNotExpired.selector, jobId)
        );
        market.forceClose(jobId);
    }
    ...
    function test_RevertWhen_ForceClose_AlreadySettled() public {
        ...
        vm.warp(block.timestamp + market.MAX_JOB_LIFETIME());
        vm.expectRevert(abi.encodeWithSelector(PromusMarket.AlreadySettled.selector, jobId));
        market.forceClose(jobId);
    }
    ...
    function test_RevertWhen_GetJob_InvalidId() public {
        vm.expectRevert(abi.encodeWithSelector(PromusMarket.JobNotFound.selector, uint256(0)));
        market.getJob(0);
    }

    function test_RevertWhen_GetJob_OutOfRange() public {
        _createFundedJob();
        vm.expectRevert(abi.encodeWithSelector(PromusMarket.JobNotFound.selector, uint256(5)));
        market.getJob(5);
    }
    ...
    function test_RevertWhen_FeeRecipientReverts() public {
        ...
        PromusMarket badMarket = new PromusMarket(address(bad));
