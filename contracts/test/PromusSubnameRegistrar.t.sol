...
contract PromusSubnameRegistrarTest is Test {
    ...
    function test_EmptyLabelReverts() public {
        vm.expectRevert(PromusSubnameRegistrar.EmptyLabel.selector);
        reg.claim("", alice);
    }
    ...
    function test_TooLongLabelReverts() public {
        ...
        vm.expectRevert(PromusSubnameRegistrar.LabelTooLong.selector);
    ...
    function test_DoubleClaimReverts() public {
        ...
        vm.prank(carol);
        vm.expectRevert(PromusSubnameRegistrar.LabelAlreadyTaken.selector);
    ...
    function test_ConstructorRevertsOnPromusOwnerMismatch() public {
        vm.expectRevert(PromusSubnameRegistrar.PromusOwnerMismatch.selector);
        new PromusSubnameRegistrar(address(registry), resolver, alice);
    }
